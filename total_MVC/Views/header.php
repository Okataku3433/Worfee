...
<header class="p-3  text-white">
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <div class="text-end">
          <button type="button" class="btn_head"><a href="login.php" class="nav-link3">ログイン</a></button>
          <button type="button" class="btn_head"><a href="signup.php" class="nav-link3">新規登録</a></button>
        </div>
      </div>
    </div>
  </header>
